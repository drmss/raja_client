...
class BackTickets extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tickets: [],
    ...
    componentDidMount() {
        this.api.searchTicket(
            ...
            localStorage.getItem("date_back")
        );
    }

    getDate = () => {
        return localStorage.getItem("date_back");
    };
    ...
    selectTicket = (ticket) => {
        localStorage.setItem("back_ticket", ticket.id);
                    ...
                    <div className="col-lg-8 offset-lg-2">
                        <div className="content">
                            <div className="page-title">
                                انتخاب بلیط برگشت در تاریخ <span>{ this.getDate() }</span>
                            </div>
